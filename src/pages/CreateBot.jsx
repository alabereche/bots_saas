...
const CHANNELS_CONFIG = [  {
    ...
    desc: 'ربط رقم المتجر بمسح كود QR وإرسال صور الكتالوج وتأكيد الطلبيات',
    color: '#25D366',
    icon: (
  ...
  {
    id: 'telegram',
    name: 'تيليغرام (Telegram)',
    subtitle: 'Telegram Bot',
    desc: 'ربط توكن BotFather مع شحن وتتبع الطلبيات آلياً',
    color: '#26A5E4',
    icon: (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
      ...
      {pendingTemplate ? (
        <section className="tpl-screen">
          ...
          <div className="tpl-skip">
            <button type="button" className="btn btn-primary tpl-skip-btn" onClick={() => setPendingTemplate(false)}>
