    ...
    <div className="landing-page-root" style={{ minHeight: '100vh', padding: '4rem 1.5rem', direction: 'rtl' }}>
      ...
      <div style={{ maxWidth: '850px', margin: '0 auto', background: 'rgba(14, 21, 38, 0.9)', border: '1px solid var(--border-default)', borderRadius: '20px', padding: '2.5rem', position: 'relative', zIndex: 10, backdropFilter: 'blur(10px)' }}>
        ...
        <div style={{ marginTop: '2rem', color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: '1.9' }}>
          <h2 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', marginTop: '1.5rem', marginBottom: '0.5rem' }}>1. قبول الشروط</h2>
          <p>
          ...
          <h2 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', marginTop: '1.5rem', marginBottom: '0.5rem' }}>2. الاستخدام المصرح به</h2>
          <p>
          ...
          <h2 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', marginTop: '1.5rem', marginBottom: '0.5rem' }}>3. حدود المسؤولية</h2>
          <p>
