...
export default function CreateBot() {
  ...
  const validateStep3 = () => {
    ...
    if (!openrouterKey) {
      toast.error('يرجى ادخال مفتاح OpenRouter API');
      return false;
    }
    return true;
  };
      ...
      <div className="card">
        ...
        {step === 3 && (
          <div className="wizard-body">
            ...
            <div className="form-group">
              <label className="form-label">مفتاح OpenRouter API <span className="required">*</span></label>
              <input type="password" className="form-input" placeholder="sk-or-..." value={openrouterKey} onChange={e => setOpenrouterKey(e.target.value)} dir="ltr" style={{ fontFamily: 'var(--font-mono)', fontSize: 'var(--text-sm)' }} />
              <p className="form-helper">يمكنك الحصول عليه من openrouter.ai</p>
            </div>
            ...
            <div style={{ marginTop: 'var(--space-6)', paddingTop: 'var(--space-6)', borderTop: '1px solid var(--border-subtle)' }}>
              <h4 style={{ fontSize: '1rem', fontWeight: 600, color: 'var(--text-primary)', marginBottom: 'var(--space-4)', display: 'flex', alignItems: 'center', gap: 'var(--space-2)' }}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="var(--accent-secondary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                مفاتيح أخرى (اختياري)
              </h4>
              <p style={{ color: 'var(--text-tertiary)', fontSize: '0.8125rem', marginBottom: 'var(--space-4)' }}>
                إذا كنت ترغب باستخدام نماذج مدفوعة خاصة بك، أضف مفتاح API للمزود هنا:
              </p>

              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                <div className="form-group" style={{ margin: 0 }}>
                  <label className="form-label" style={{ fontSize: '0.8125rem' }}>مفتاح Anthropic API (Claude)</label>
                  <input type="password" className="form-input" placeholder="sk-ant-..." value={anthropicKey} onChange={e => setAnthropicKey(e.target.value)} dir="ltr" style={{ fontFamily: 'var(--font-mono)', fontSize: '14px', padding: '0.6rem 0.75rem' }} />
                </div>
                
                <div className="form-group" style={{ margin: 0 }}>
                  <label className="form-label" style={{ fontSize: '0.8125rem' }}>مفتاح OpenAI API (ChatGPT)</label>
                  <input type="password" className="form-input" placeholder="sk-proj-..." value={openaiKey} onChange={e => setOpenaiKey(e.target.value)} dir="ltr" style={{ fontFamily: 'var(--font-mono)', fontSize: '14px', padding: '0.6rem 0.75rem' }} />
                </div>
                
                <div className="form-group" style={{ margin: 0 }}>
                  <label className="form-label" style={{ fontSize: '0.8125rem' }}>مفتاح Gemini API (Google AI Studio)</label>
                  <input type="password" className="form-input" placeholder="AIzaSy..." value={geminiKey} onChange={e => setGeminiKey(e.target.value)} dir="ltr" style={{ fontFamily: 'var(--font-mono)', fontSize: '14px', padding: '0.6rem 0.75rem' }} />
                </div>
              </div>
            </div>
          </div>
