  ...
  return (
    <div className="landing-page-root" style={{ minHeight: '100vh', padding: '4rem 1.5rem', direction: 'rtl' }}>
      ...
      <div style={{ maxWidth: '850px', margin: '0 auto', background: 'rgba(17, 17, 16, 0.9)', border: '1px solid var(--border-default)', borderRadius: '20px', padding: '2.5rem', position: 'relative', zIndex: 10, backdropFilter: 'blur(10px)' }}>
        ...
        <h1 style={{ fontSize: '2rem', color: 'var(--text-primary)', marginBottom: '1rem', borderBottom: '1px solid rgba(255, 255, 255, 0.08)', paddingBottom: '1rem' }}>
        ...
        <div style={{ marginTop: '2rem', color: 'var(--text-secondary)', fontSize: '0.95rem', lineHeight: '1.9' }}>
          <h2 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', marginTop: '1.5rem', marginBottom: '0.5rem' }}>1. جمع المعلومات واستخدامها</h2>
          <p>
          ...
          <h2 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', marginTop: '1.5rem', marginBottom: '0.5rem' }}>2. أمان وتشفير البيانات</h2>
          <p>
          ...
          <h2 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', marginTop: '1.5rem', marginBottom: '0.5rem' }}>3. صلاحيات Meta (Facebook & Instagram)</h2>
          <p>
          ...
          <h2 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', marginTop: '1.5rem', marginBottom: '0.5rem' }}>4. حذف البيانات</h2>
          <p>
          ...
          <h2 style={{ color: 'var(--text-primary)', fontSize: '1.25rem', marginTop: '1.5rem', marginBottom: '0.5rem' }}>5. التواصل معنا</h2>
          <p>
