    ...
    <div className="page-container animate-enter">
          ...
          <div className="premium-grid-2">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
              <div className="premium-card">
                ...
                <div className="premium-card-content">
                  <InfoRowV3 label="مزود الخدمة" value={bot.aiProvider || 'openrouter'} />
                  <InfoRowV3 label="النموذج المستخدم" value={bot.aiModel?.split('/').pop()} />
        ...
        <div className="modal-overlay" onClick={() => !clearing && setShowClearMessagesModal(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <h3 className="modal-title" style={{ color: 'var(--color-error)' }}>مسح جميع المحادثات</h3>
              <button className="btn btn-ghost btn-icon" onClick={() => !clearing && setShowClearMessagesModal(false)}>
            ...
            <div className="modal-body">
              <p style={{ color: 'var(--text-secondary)' }}>
                ...
                <br /><br />
                هذا الإجراء سيحذف السجل بالكامل ولا يمكن التراجع عنه.
              </p>
            </div>
            <div className="modal-footer">
              <button className="btn btn-danger" onClick={clearMessages} disabled={clearing}>
                {clearing ? <span className="spinner" /> : 'نعم، مسح المحادثات'}
              </button>
              <button className="btn btn-secondary" onClick={() => setShowClearMessagesModal(false)} disabled={clearing}>الغاء</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showClearOrdersModal && (
        <div className="modal-overlay" onClick={() => !clearing && setShowClearOrdersModal(false)}>
          <div className="modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              <h3 className="modal-title" style={{ color: 'var(--color-error)' }}>مسح جميع الطلبيات</h3>
              <button className="btn btn-ghost btn-icon" onClick={() => !clearing && setShowClearOrdersModal(false)}>
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
              </button>
            </div>
            <div className="modal-body">
              <p style={{ color: 'var(--text-secondary)' }}>
                هل أنت متأكد من رغبتك في مسح <strong>جميع سجلات الطلبيات</strong> لهذا البوت؟
                <br /><br />
            ...
            <div className="modal-footer">
              <button className="btn btn-danger" onClick={clearOrders} disabled={clearing}>
                {clearing ? <span className="spinner" /> : 'نعم، مسح الطلبيات'}
              </button>
              <button className="btn btn-secondary" onClick={() => setShowClearOrdersModal(false)} disabled={clearing}>الغاء</button>
            </div>
          </div>
        </div>
      )}
