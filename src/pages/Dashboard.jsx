                ...
                >
                  <div className="bot-item-header">
                    <div style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
                      {(bot.facebookEnabled || bot.facebookPageId || bot.platform === 'facebook') && (
                        <span title="Facebook Messenger" style={{ color: '#0084FF', background: 'rgba(0, 132, 255, 0.1)', padding: '5px', borderRadius: '8px', display: 'flex' }}>
                          <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.373 0 0 4.974 0 11.111c0 3.498 1.744 6.614 4.469 8.654V24l4.088-2.242c1.093.303 2.253.464 3.443.464 6.627 0 12-4.974 12-11.111C24 4.974 18.627 0 12 0zm1.191 14.963l-3.055-3.26-5.963 3.26 6.559-6.963 3.13 3.26 5.889-3.26-6.56 6.963z"/></svg>
                        </span>
                      )}
                      {(bot.instagramEnabled || bot.instagramUserId || bot.platform === 'instagram') && (
                        <span title="Instagram Direct" style={{ color: '#E4405F', background: 'rgba(228, 64, 95, 0.1)', padding: '5px', borderRadius: '8px', display: 'flex' }}>
                      ...
                      {(bot.whatsappEnabled || bot.platform === 'whatsapp') && (
                        <span title="WhatsApp" style={{ color: '#25D366', background: 'rgba(37, 211, 102, 0.1)', padding: '5px', borderRadius: '8px', display: 'flex' }}>
                      ...
                      {(bot.telegramEnabled || bot.telegramToken || bot.platform === 'telegram') && (
                        <span title="Telegram" style={{ color: '#26A5E4', background: 'rgba(38, 165, 228, 0.1)', padding: '5px', borderRadius: '8px', display: 'flex' }}>
